...
window.addEventListener("load", async () => {
    ...
    const acc = new _tonclient_core__WEBPACK_IMPORTED_MODULE_0__.Account({abi:_ContestContract__WEBPACK_IMPORTED_MODULE_2__.ContestContract},{address});
